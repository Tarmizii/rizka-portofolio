  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      <aside className="w-64 border-r border-background/20 p-4">
        <nav className="space-y-2">
          ...
          <div className="space-y-1 mt-1">
            ...
            <a href="/admin/settings" className="px-3 py-2 bg-accent rounded-md block">Settings</a>
          </div>
      ...
      <div className="flex-1 flex flex-col">
        <header className="border-b border-background/20 p-4 flex items-center justify-between">
          <div className="font-semibold">Portfolio CMS</div>
